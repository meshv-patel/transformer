...
export const SCENES = [
  ...
  { id: 'proj-q',           group: 'Attention', title: 'Linear Projection to Q',    subSteps: ['weight-matrix', 'matmul'] },
  { id: 'proj-k',           group: 'Attention', title: 'Linear Projection to K',    subSteps: ['weight-matrix', 'matmul'] },
  { id: 'proj-v',           group: 'Attention', title: 'Linear Projection to V',    subSteps: ['weight-matrix', 'matmul'] },
  { id: 'split-heads',      group: 'Attention', title: 'Split into Multiple Heads', subSteps: ['reshape', 'transpose'] },
  { id: 'qk-matmul',        group: 'Attention', title: 'Q × Kᵀ',                    subSteps: ['dot-products', 'raw-scores'] },
  { id: 'scale-softmax',    group: 'Attention', title: 'Scaling & Softmax',         subSteps: ['divide-sqrt-dk', 'softmax-curve'] },
  { id: 'weighted-sum',     group: 'Attention', title: 'Weighted Sum',              subSteps: ['weight-values', 'sum', 'before-after', 'quick-check'] },
  { id: 'heads-compare',    group: 'Attention', title: 'Individual Attention Heads',subSteps: ['per-head-heatmaps'] },
  { id: 'concat',           group: 'Attention', title: 'Concatenation',             subSteps: ['stitch-heads'] },
  { id: 'output-proj',      group: 'Attention', title: 'Output Projection (Wo)',    subSteps: ['matmul'] },
